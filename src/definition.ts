import { NBTData, TAG, getTagType, fromListUnsafe, fromCompoundUnsafe } from "nbtify";

import type { RootTag, Tag, ListTag, ListTagUnsafe, CompoundTag, CompoundTagUnsafe } from "nbtify";
